...
#                                                                         #
# Implementation of SConvolutional Neural Network with multiple channels  #
# for classifying MNIST dataset containing hand-written digits (0-9)      #
# using Stochastic Gradient Descent. Target accuracy on Test Set was      #
# 97% - 98%, This implementation achieved --% accuracy with the follwing  #
# hyperparameters:                                                        #
